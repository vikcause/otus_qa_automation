...
def test_rectangle_area_positive(width, height, area, work_with_api):
...
def test_rectangle_area_positive_data_from_fixture(rectangle_data,
                                                   rectangle_params):
...
@pytest.mark.parametrize(("width", "height"),
                         ...
                         ids=["below zero width int", "below zero "
                              ...
                              "one side zero"])
@pytest.mark.otus
def test_rectangle_negative(width, height):
